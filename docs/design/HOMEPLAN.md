...
|---|---|---|
| Breaking out of layout padding with negative margins is fragile | Medium | Test at all breakpoints; the negative margin values must exactly match `(public)/layout.tsx` padding values (`px-4 py-6 sm:px-6 md:py-10 lg:px-8`) |
