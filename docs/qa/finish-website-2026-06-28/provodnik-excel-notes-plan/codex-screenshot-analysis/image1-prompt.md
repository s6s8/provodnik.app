...
## This screenshot
- Image: docs/qa/finish-website-2026-06-28/provodnik-excel-notes-plan/extracted-media/image1.png
- Workbook location: Login A1
- Route/area: /auth left trust panel
- Known complaint: Confusing auth trust copy: free for travelers, honest price, vague support.
