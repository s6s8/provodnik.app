...
## This screenshot
- Image: /Users/idev/provodnik/docs/qa/finish-website-2026-06-28/provodnik-excel-notes-plan/extracted-media/image9.png
- Workbook location: Sheet10 A2
- Route/area: /admin/guides
- Known complaint: Admin guide queue/action shows red failure card; admin cannot tell whether verification application arrived.
