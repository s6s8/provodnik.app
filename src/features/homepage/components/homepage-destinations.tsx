...
function DestinationCard({
  ...
  return (
    ...
    >
      ...
      {card.badge ? (
        <span className="absolute right-3 top-3 inline-flex h-6 items-center rounded-full bg-[rgba(217,119,6,0.9)] px-2.5 text-[0.625rem] font-semibold text-white shadow-md ring-1 ring-white/25">
          {card.badge}
        </span>
      ) : null}
