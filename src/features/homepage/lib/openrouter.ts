...
- история/прошлое/исторические места/архитектура/здания/дома/особняки -> history_culture
...
- ночь/вечер/ночные прогулки/огни города -> night
- активный отдых/спорт/походы/велосипеды/с детьми/семейное -> active
- вода/лодка/катер/река/каналы/море -> water
