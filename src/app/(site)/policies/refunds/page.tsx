        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-prose text-sm leading-7 text-muted-foreground sm:text-base">
              Эта политика описывает общий подход Provodnik к возвратам на этапе MVP. Финальные
              юридические формулировки могут отличаться, но принципы прозрачности и здравого смысла
              останутся такими же.
            </p>
          </div>
        </div>
