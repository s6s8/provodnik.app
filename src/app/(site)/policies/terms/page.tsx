...
const disputeSteps = [
  ...
  "Мы вправе запросить переписку, подтверждения оплаты, фото, документы и иные материалы, относящиеся к спору. Срок ответа на такой запрос должен быть разумным.",
    ...
    <div className="space-y-10">
      ...
      <Card className="border-border/70 bg-card/80">
        ...
        <CardContent className="space-y-3 text-sm text-muted-foreground">
          ...
          <p>
            Вопросы о возвратах и сроках отмены дополнительно описаны в{" "}
            <Link
