...
export async function generateMetadata({
  ...
  const result = await getGuideBySlug(client, id);
...
export default async function GuidePage({
  ...
  const reviews = (reviewsResult.data ?? []).map((r) => ({
    ...
    target: { type: "guide" as const, slug: id },
