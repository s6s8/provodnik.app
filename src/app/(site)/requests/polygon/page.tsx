...
import { PublicRequestsMarketplacePolygonScreen } from "@/features/requests/components/public-requests-marketplace-polygon-screen";
import { createSupabaseServerClient } from "@/lib/supabase/server";

export function generateMetadata(): Metadata {
  return {
    title: "Центр запросов · Polygon",
    description: "Прототип фильтров запросов путешественников для гидов",
  };
}
...
export default async function RequestsPolygonPage() {
  ...
  try {
    ...
    console.error("[RequestsPolygonPage] failed to load initial requests:", error);
  }

  return <PublicRequestsMarketplacePolygonScreen initialData={initialData} />;
}
