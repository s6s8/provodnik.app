      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          {tagSlots.map((_, index) => (
            <div key={index} className="h-7 w-24 rounded-full bg-muted/60 animate-pulse" />
          ))}
        </div>
      </div>
