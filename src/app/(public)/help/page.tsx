...
**Открытый запрос на Бирже.** Перейдите в раздел «Запросы» и опишите поездку — даты, направление, пожелания. Ваш запрос увидят гиды по выбранному городу, и вы получите несколько предложений с маршрутом и ценой. Сравните и выберите подходящее.
