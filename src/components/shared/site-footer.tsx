...
const faqItems = [
  {
    ...
    a: "Да. Выберите тип Сборная группа при создании запроса — или загляните в Биржу и присоединяйтесь к чужому, если он подходит по датам и интересам.",
  },
  {
  ...
  },
  {
    ...
    a: "Корпоративные заявки оформляем индивидуально через поддержку: счёт на юрлицо, договор, безналичная оплата с расчётного счёта и закрывающие документы (акт, УПД) выставляет гид или партнёр-исполнитель напрямую. Подробности — на странице «Для бизнеса» или напишите на support@provodnik.app с темой «Корпоративная заявка».",
  },
] as const;
