...
export function SiteFooter() {
  return (
    <footer className="border-t border-white/8 bg-[#0a0a0a]">
      <div className="mx-auto grid w-full max-w-[1400px] gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
        <div className="space-y-4">
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-white/50">
            Provodnik
          </p>
          <h2 className="max-w-md text-3xl font-semibold tracking-tight text-white/80 sm:text-4xl">
