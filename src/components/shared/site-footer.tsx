...
const faqItems = [
  {
    ...
    a: "Да. Выберите тип Открытая группа при создании запроса — или загляните в центр запросов и присоединяйтесь к чужому, если он подходит по датам и интересам.",
  },
  {
