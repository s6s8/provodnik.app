...
- Комиссия: 15% на запросах (модели 1 и 2), 25% на готовых (модель 3).
  Отменяет прежнее «0% в v1» — решение владельца 2026-05-18 (см. раздел
  «Три модели продукта»). Пока нет платёжного шлюза, комиссия и вся
