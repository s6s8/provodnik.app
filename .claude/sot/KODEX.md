...
**Модель 1 — «Открытая группа»** (MVP, ядро продукта, ноу-хау).
...
Термин «Открытая группа» заменяет «Сборная группа» — решение владельца
2026-06-03 (причина: описывает свойство «можно присоединиться», а не
процесс; интуитивнее для пользователя без контекста туриндустрии).
...
| Фаза | Модель 1 «Открытая группа» | Модель 2 «Своя группа» | Модель 3 «Готовые экскурсии» | Revisit trigger |
|---|---|---|---|---|
