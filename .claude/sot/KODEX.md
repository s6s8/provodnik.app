...
- Комиссия (Phase A — Элиста, решение владельца 2026-05-26 в эпике формы):
  **единая 10%** по всем моделям. Источник правды для product code:
  COMMISSION_PCT в src/config/commission.ts. Маркетинговый wedge против
  Sputnik8 24%+ и Tripster effective-prepayment.
- Комиссия (Phase B и далее, решение владельца 2026-05-18, пересмотрено
  для Phase A 2026-05-26): 15% на запросах (модели 1 и 2), 25% на
  готовых (модель 3). Отменяет прежнее «0% в v1». Возврат к модель-
  зависимой ставке — после доказательства Phase A unit-economics.
  Пока нет платёжного шлюза, комиссия и вся оплата идут вне платформы;
  платёжный шлюз — задел на будущее.
