...
insert into public.destinations (slug,name,region,category,description,hero_image_url,listing_count,guides_count,rating) values
  ...
  ('kazan-tatarstan',  'Казань',            'Татарстан',             'culture','Казань удобна для короткой поездки на выходные и для насыщенного гастрономического маршрута. Исторический центр, татарская кухня и спокойная логистика делают город понятным уже с первого дня.','https://images.unsplash.com/photo-1664358201853-d1274b84cbbe?auto=format&fit=crop&w=1600&h=1200&q=80',2,1,4.9),
  ('nizhny-novgorod',  'Нижний Новгород',   'Нижегородская область', 'city','Нижний Новгород даёт сильные панорамы и ощущение большого исторического города без столичной суеты. Здесь удобно сочетать кремль, купеческие улицы и короткие выезды к воде или на природу.','https://images.unsplash.com/photo-1636622406136-fe729cbc0f8e?auto=format&fit=crop&w=1600&h=1200&q=80',1,1,4.6),
