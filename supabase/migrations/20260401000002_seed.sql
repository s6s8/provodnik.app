...
values
  ('admin@provodnik.test',          '10000000-0000-4000-8000-000000000001', '{"sub":"10000000-0000-4000-8000-000000000001","email":"admin@provodnik.test","email_verified":true,"phone_verified":false}'::jsonb,          'email', t, t, t),
  ('traveler@provodnik.test',       '20000000-0000-4000-8000-000000000001', '{"sub":"20000000-0000-4000-8000-000000000001","email":"traveler@provodnik.test","email_verified":true,"phone_verified":false}'::jsonb,       'email', t, t, t),
  ('guide@provodnik.test',          '30000000-0000-4000-8000-000000000001', '{"sub":"30000000-0000-4000-8000-000000000001","email":"guide@provodnik.test","email_verified":true,"phone_verified":false}'::jsonb,          'email', t, t, t),
  ('admin@provodnik.app',           '00000000-0000-4000-8000-000000000001', '{"sub":"00000000-0000-4000-8000-000000000001","email":"admin@provodnik.app","email_verified":true,"phone_verified":false}'::jsonb,           'email', t, t, t),
  ('guide@provodnik.app',           '00000000-0000-4000-8000-000000000002', '{"sub":"00000000-0000-4000-8000-000000000002","email":"guide@provodnik.app","email_verified":true,"phone_verified":false}'::jsonb,           'email', t, t, t),
  ('traveler@provodnik.app',        '00000000-0000-4000-8000-000000000003', '{"sub":"00000000-0000-4000-8000-000000000003","email":"traveler@provodnik.app","email_verified":true,"phone_verified":false}'::jsonb,        'email', t, t, t),
  ('guide.elista@example.com',      '10000000-0000-4000-8000-000000000101', '{"sub":"10000000-0000-4000-8000-000000000101","email":"guide.elista@example.com","email_verified":true,"phone_verified":false}'::jsonb,      'email', t, t, t),
  ('guide.kazan@example.com',       '10000000-0000-4000-8000-000000000102', '{"sub":"10000000-0000-4000-8000-000000000102","email":"guide.kazan@example.com","email_verified":true,"phone_verified":false}'::jsonb,       'email', t, t, t),
  ('guide.spb@example.com',         '10000000-0000-4000-8000-000000000103', '{"sub":"10000000-0000-4000-8000-000000000103","email":"guide.spb@example.com","email_verified":true,"phone_verified":false}'::jsonb,         'email', t, t, t),
  ('guide.sochi@example.com',       '10000000-0000-4000-8000-000000000104', '{"sub":"10000000-0000-4000-8000-000000000104","email":"guide.sochi@example.com","email_verified":true,"phone_verified":false}'::jsonb,       'email', t, t, t),
  ('guide.baikal@example.com',      '10000000-0000-4000-8000-000000000105', '{"sub":"10000000-0000-4000-8000-000000000105","email":"guide.baikal@example.com","email_verified":true,"phone_verified":false}'::jsonb,      'email', t, t, t),
  ('traveler.anna@example.com',     '10000000-0000-4000-8000-000000000201', '{"sub":"10000000-0000-4000-8000-000000000201","email":"traveler.anna@example.com","email_verified":true,"phone_verified":false}'::jsonb,     'email', t, t, t),
  ('traveler.dmitry@example.com',   '10000000-0000-4000-8000-000000000202', '{"sub":"10000000-0000-4000-8000-000000000202","email":"traveler.dmitry@example.com","email_verified":true,"phone_verified":false}'::jsonb,   'email', t, t, t),
  ('traveler.olga@example.com',     '10000000-0000-4000-8000-000000000203', '{"sub":"10000000-0000-4000-8000-000000000203","email":"traveler.olga@example.com","email_verified":true,"phone_verified":false}'::jsonb,     'email', t, t, t),
  ('traveler.sergey@example.com',   '10000000-0000-4000-8000-000000000204', '{"sub":"10000000-0000-4000-8000-000000000204","email":"traveler.sergey@example.com","email_verified":true,"phone_verified":false}'::jsonb,   'email', t, t, t),
  ('traveler.irina@example.com',    '10000000-0000-4000-8000-000000000205', '{"sub":"10000000-0000-4000-8000-000000000205","email":"traveler.irina@example.com","email_verified":true,"phone_verified":false}'::jsonb,    'email', t, t, t),
  ('traveler.maksim@example.com',   '10000000-0000-4000-8000-000000000206', '{"sub":"10000000-0000-4000-8000-000000000206","email":"traveler.maksim@example.com","email_verified":true,"phone_verified":false}'::jsonb,   'email', t, t, t),
  ('traveler.svetlana@example.com', '10000000-0000-4000-8000-000000000207', '{"sub":"10000000-0000-4000-8000-000000000207","email":"traveler.svetlana@example.com","email_verified":true,"phone_verified":false}'::jsonb, 'email', t, t, t),
  ('traveler.pavel@example.com',    '10000000-0000-4000-8000-000000000208', '{"sub":"10000000-0000-4000-8000-000000000208","email":"traveler.pavel@example.com","email_verified":true,"phone_verified":false}'::jsonb,    'email', t, t, t)
