...
-- AUTH USERS
-- ---------------------------------------------------------------------------
insert into auth.users (id, instance_id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, is_sso_user, confirmation_token, email_change, email_change_token_new, recovery_token)
values
  -- test accounts
  ...
  ('00000000-0000-4000-8000-000000000003','00000000-0000-0000-0000-000000000000','authenticated','authenticated','traveler@provodnik.app', extensions.crypt('Demo1234!',   extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"traveler"}','{"role":"traveler","full_name":"Демо Путешественник"}',                                                         t,t,false,'','','',''),
  -- seed guides
  ('10000000-0000-4000-8000-000000000101','00000000-0000-0000-0000-000000000000','authenticated','authenticated','guide.elista@example.com', extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"guide"}',   '{"role":"guide","full_name":"Елена Воронина"}',    t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000102','00000000-0000-0000-0000-000000000000','authenticated','authenticated','guide.kazan@example.com',  extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"guide"}',   '{"role":"guide","full_name":"Тимур Сафин"}',     t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000103','00000000-0000-0000-0000-000000000000','authenticated','authenticated','guide.spb@example.com',    extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"guide"}',   '{"role":"guide","full_name":"Анна Белова"}',      t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000104','00000000-0000-0000-0000-000000000000','authenticated','authenticated','guide.sochi@example.com',  extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"guide"}',   '{"role":"guide","full_name":"Максим Королёв"}',   t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000105','00000000-0000-0000-0000-000000000000','authenticated','authenticated','guide.baikal@example.com', extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"guide"}',   '{"role":"guide","full_name":"Мария Гречко"}',      t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000106','00000000-0000-0000-0000-000000000000','authenticated','authenticated','guide.vladivostok@example.com', extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"guide"}',   '{"role":"guide","full_name":"Ирина Захарова"}',   t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000107','00000000-0000-0000-0000-000000000000','authenticated','authenticated','guide.altai@example.com',       extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"guide"}',   '{"role":"guide","full_name":"Андрей Волков"}',    t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000108','00000000-0000-0000-0000-000000000000','authenticated','authenticated','guide.kaliningrad@example.com', extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"guide"}',   '{"role":"guide","full_name":"Елизавета Морозова"}',t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000109','00000000-0000-0000-0000-000000000000','authenticated','authenticated','guide.yaroslavl@example.com',   extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"guide"}',   '{"role":"guide","full_name":"Павел Громов"}',     t,t,false,'','','',''),
  -- seed travelers
  ('10000000-0000-4000-8000-000000000201','00000000-0000-0000-0000-000000000000','authenticated','authenticated','traveler.anna@example.com',    extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"traveler"}','{"role":"traveler","full_name":"Анна Пахомова"}',      t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000202','00000000-0000-0000-0000-000000000000','authenticated','authenticated','traveler.dmitry@example.com',  extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"traveler"}','{"role":"traveler","full_name":"Дмитрий Лазарев"}',    t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000203','00000000-0000-0000-0000-000000000000','authenticated','authenticated','traveler.olga@example.com',    extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"traveler"}','{"role":"traveler","full_name":"Ольга Мельникова"}',   t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000204','00000000-0000-0000-0000-000000000000','authenticated','authenticated','traveler.sergey@example.com',  extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"traveler"}','{"role":"traveler","full_name":"Сергей Тарасов"}',     t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000205','00000000-0000-0000-0000-000000000000','authenticated','authenticated','traveler.irina@example.com',   extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"traveler"}','{"role":"traveler","full_name":"Ирина Власова"}',      t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000206','00000000-0000-0000-0000-000000000000','authenticated','authenticated','traveler.maksim@example.com',  extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"traveler"}','{"role":"traveler","full_name":"Максим Кудрявцев"}',   t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000207','00000000-0000-0000-0000-000000000000','authenticated','authenticated','traveler.svetlana@example.com',extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"traveler"}','{"role":"traveler","full_name":"Светлана Никитина"}', t,t,false,'','','',''),
  ('10000000-0000-4000-8000-000000000208','00000000-0000-0000-0000-000000000000','authenticated','authenticated','traveler.pavel@example.com',   extensions.crypt('SeedPass1!', extensions.gen_salt('bf')),t,'{"provider":"email","providers":["email"],"role":"traveler"}','{"role":"traveler","full_name":"Павел Романов"}',      t,t,false,'','','','')
...
values
  ...
  (gen_random_uuid(),'10000000-0000-4000-8000-000000000106','10000000-0000-4000-8000-000000000106','{"sub":"10000000-0000-4000-8000-000000000106","email":"guide.vladivostok@example.com","email_verified":true,"phone_verified":false}'::jsonb,'email', t, t, t),
  (gen_random_uuid(),'10000000-0000-4000-8000-000000000107','10000000-0000-4000-8000-000000000107','{"sub":"10000000-0000-4000-8000-000000000107","email":"guide.altai@example.com","email_verified":true,"phone_verified":false}'::jsonb,      'email', t, t, t),
  (gen_random_uuid(),'10000000-0000-4000-8000-000000000108','10000000-0000-4000-8000-000000000108','{"sub":"10000000-0000-4000-8000-000000000108","email":"guide.kaliningrad@example.com","email_verified":true,"phone_verified":false}'::jsonb,'email', t, t, t),
  (gen_random_uuid(),'10000000-0000-4000-8000-000000000109','10000000-0000-4000-8000-000000000109','{"sub":"10000000-0000-4000-8000-000000000109","email":"guide.yaroslavl@example.com","email_verified":true,"phone_verified":false}'::jsonb,  'email', t, t, t),
...
insert into public.profiles (id, role, email, full_name, avatar_url) values
  ...
  -- seed guides
  ('10000000-0000-4000-8000-000000000101','guide',   'guide.elista@example.com', 'Елена Воронина', 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&h=400&q=80'),
  ...
  ('10000000-0000-4000-8000-000000000104','guide',   'guide.sochi@example.com',  'Максим Королёв', 'https://images.unsplash.com/photo-1463453091185-61582044d556?auto=format&fit=crop&w=400&h=400&q=80'),
  ('10000000-0000-4000-8000-000000000105','guide',   'guide.baikal@example.com', 'Мария Гречко',   'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?auto=format&fit=crop&w=400&h=400&q=80'),
  ('10000000-0000-4000-8000-000000000106','guide',   'guide.vladivostok@example.com','Ирина Захарова',      'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&w=400&h=400&q=80'),
  ('10000000-0000-4000-8000-000000000107','guide',   'guide.altai@example.com',      'Андрей Волков',       'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&h=400&q=80'),
  ('10000000-0000-4000-8000-000000000108','guide',   'guide.kaliningrad@example.com','Елизавета Морозова',  'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?auto=format&fit=crop&w=400&h=400&q=80'),
  ('10000000-0000-4000-8000-000000000109','guide',   'guide.yaroslavl@example.com',  'Павел Громов',        'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=400&h=400&q=80'),
  -- seed travelers
...
insert into public.guide_profiles (user_id, slug, display_name, bio, years_experience, regions, languages, specialties, specialization, attestation_status, verification_status, verification_notes, payout_account_label, rating, completed_tours, is_available) values
  ...
  ('10000000-0000-4000-8000-000000000106','irina-zaharova','Ирина Захарова','Провожу маршруты по Владивостоку и Приморскому краю — морские виды, корейские кварталы и короткие выезды на острова.',6,array['Владивосток','Приморский край','Русский остров'],array['Русский'],array['Природа','Морские маршруты','Городские туры'],'Природа','Проверенный гид','approved',null,null,4.8,19,true),
  ('10000000-0000-4000-8000-000000000107','andrei-volkov','Андрей Волков','Специализируюсь на пеших маршрутах по Алтаю. Помогаю выстроить тур под любой уровень подготовки — от семейной прогулки до многодневного трека.',9,array['Алтай','Горно-Алтайск','Чемал'],array['Русский'],array['Треккинг','Природа','Горные маршруты'],'Треккинг','Проверенный гид','approved',null,null,4.9,63,true),
  ('10000000-0000-4000-8000-000000000108','elizaveta-morozova','Елизавета Морозова','Показываю Калининград через его европейскую историю, старые районы и балтийское побережье. Хороший формат для пары или небольшой группы.',7,array['Калининград','Светлогорск','Куршская коса'],array['Русский'],array['История','Архитектура','Прогулки у воды'],'История','Проверенный гид','approved',null,null,4.7,22,true),
  ('10000000-0000-4000-8000-000000000109','pavel-gromov','Павел Громов','Маршруты по Ярославлю и Золотому кольцу. Умею делать историю понятной без скучных лекций — через детали, еду и живые истории.',11,array['Ярославль','Ростов Великий','Переславль-Залесский'],array['Русский'],array['История','Золотое кольцо','Гастрономия'],'История','Проверенный гид','approved',null,null,4.8,41,true)
...
insert into public.traveler_requests (id,traveler_id,destination,region,category,starts_on,ends_on,budget_minor,currency,participants_count,format_preference,notes,open_to_join,allow_guide_suggestions,group_capacity,status) values
  ('30000000-0000-4000-8000-000000000000','00000000-0000-4000-8000-000000000003','Москва, Россия','Москва','Городская экскурсия',date '2026-07-20',date '2026-07-22',480000,'RUB',2,'Нужен маршрут по центру Москвы с одной музейной точкой и без долгих переездов. Оптимально — пешая прогулка с кофейной паузой. Группа из двух взрослых, темп средний.',null,true,true,4,'open'),
  ('30000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000201','Москва, Московская область','Московская область','Культурный тур',date '2026-05-10',date '2026-05-11',350000,'RUB',3,'Ищем выезд в Подмосковье на один день: история усадьбы, небольшая прогулка и обед в дороге. Группа три человека, включая пожилого родителя — нужен удобный темп.',null,true,true,6,'open'),
  ('30000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000202','Казань, Россия','Татарстан','Гастрономическая экскурсия',date '2026-06-01',date '2026-06-03',420000,'RUB',2,'Хотим увидеть кремль и попробовать татарскую кухню без туристической суеты. Два взрослых, интерес к гастрономии и архитектуре. Готовы к небольшим пешим переходам.',null,true,true,5,'open'),
  ('30000000-0000-4000-8000-000000000003','10000000-0000-4000-8000-000000000203','Санкт-Петербург, Россия','Санкт-Петербург','Культурный тур',date '2026-06-12',date '2026-06-15',540000,'RUB',4,'Интересуют белые ночи, центральная архитектура и удобный маршрут для четырёх человек, включая пожилых родителей. Без долгих стояний на ногах, с паузами на кофе.',null,true,true,6,'open'),
  ('30000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000204','Нижний Новгород, Россия','Нижегородская область','Историческая прогулка',date '2026-07-05',date '2026-07-07',310000,'RUB',3,'Нужен гид по кремлю и набережным Нижнего Новгорода, без длинных переходов. Группа три человека, один ребёнок 10 лет. Хотим понять историю города и посмотреть на Оку.',null,true,true,5,'open'),
  ('30000000-0000-4000-8000-000000000005','10000000-0000-4000-8000-000000000205','Сочи, Россия','Краснодарский край','Природный тур',date '2026-08-10',date '2026-08-13',500000,'RUB',2,'Хочется совместить море, зелёные локации и лёгкую прогулку в горах. Пара, первый раз в Сочи. Без тяжёлого трекинга — формат прогулочный, с остановками на еду.',null,true,true,4,'open'),
...
insert into public.destinations (slug,name,region,category,description,hero_image_url,listing_count,guides_count,rating) values
  ...
  -- Kazan placeholder, replace with actual Kazan photo
  ('kazan-tatarstan',  'Казань',            'Татарстан',             'culture','Казань удобна для короткой поездки на выходные и для насыщенного гастрономического маршрута. Исторический центр, татарская кухня и спокойная логистика делают город понятным уже с первого дня.','https://images.unsplash.com/photo-1513326738677-b964603b136d?auto=format&fit=crop&w=1600&h=1200&q=80',2,1,4.9),
  -- Nizhny Novgorod placeholder, replace with actual city photo
  ('nizhny-novgorod',  'Нижний Новгород',   'Нижегородская область', 'city','Нижний Новгород даёт сильные панорамы и ощущение большого исторического города без столичной суеты. Здесь удобно сочетать кремль, купеческие улицы и короткие выезды к воде или на природу.','https://images.unsplash.com/photo-1520637836862-4d197d17c55a?auto=format&fit=crop&w=1600&h=1200&q=80',1,1,4.6),
